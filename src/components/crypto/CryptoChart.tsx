          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 rounded-full">
            <Card className="flex flex-col">
              ...
              <CardContent className="flex-1 p-6 pt-2">
                {portfolioData.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center h-full">
                    {/* Donut Chart */}
                    <div className="relative flex items-center justify-center">
                      <ResponsiveContainer width="100%" height={280}>
                        <PieChart>
                          <Pie data={sortedData} cx="50%" cy="50%" innerRadius={70} outerRadius={120} paddingAngle={2} dataKey="value">
                            {sortedData.map((entry, index) => <Cell key={`cell-${index}`} fill={entry.color} />)}
                          </Pie>
                          <Tooltip formatter={(value: number) => [formatCurrency(value), 'Value']} labelFormatter={label => `${label}`} />
                        </PieChart>
                      </ResponsiveContainer>
                      {/* Center Text */}
                    ...
                    {!isMobile && <DonutChartLegend topTokens={topTokens} overflowTokens={overflowTokens} totalValue={totalValue} />}
                  </div> : <div className="flex flex-col items-center justify-center h-[300px] text-center space-y-6">
            ...
            <Card className="flex flex-col">
              ...
              <CardContent className="flex-1 p-6 pt-2 overflow-auto">
                {portfolioData.length > 0 ? <div className="h-full min-h-[280px] flex items-center">
                    <ResponsiveContainer width="100%" height={280}>
        ...
        <TabsContent value="distribution">
          <Card>
            ...
            <CardContent className="overflow-auto">
              {portfolioData.length > 0 ? <ResponsiveContainer width="100%" height={400}>
                  <PieChart>
                ...
                </ResponsiveContainer> : <div className="flex flex-col items-center justify-center h-[400px] text-center space-y-6">
                  <div className="relative">
              ...
              <CardContent className="overflow-auto">
                {portfolioData.length > 0 ? <ResponsiveContainer width="100%" height={400}>
                  ...
                  bottom: 20
                      ...
                      <CartesianGrid strokeDasharray="2 2" stroke="hsl(var(--muted-foreground))" opacity={0.2} horizontal={true} vertical={false} />
                    ...
                    offset: -10
                      ...
                      <YAxis yAxisId="left" tickFormatter={value => formatCurrency(value)} axisLine={false} tickLine={false} tick={{
                    fontSize: 12,
                    fill: 'hsl(var(--muted-foreground))'
                  }} label={{
                    ...
                    position: 'insideLeft'
                      ...
                      <YAxis yAxisId="right" orientation="right" tickFormatter={value => formatPercent(value)} axisLine={false} tickLine={false} tick={{
                    fontSize: 12,
                    fill: 'hsl(var(--muted-foreground))'
                  }} label={{
                    value: 'ROI %',
                  ...
                  }} formatter={(value: number, name: string) => [name === 'value' ? formatCurrency(value) : name === 'invested' ? formatCurrency(value) : formatPercent(value), name === 'value' ? 'Current Value' : name === 'invested' ? 'Invested' : 'ROI']} labelFormatter={label => `Month: ${label}`} />
                    ...
                    strokeWidth: 2
                      ...
                      <Line yAxisId="left" type="monotone" dataKey="invested" stroke="hsl(var(--muted-foreground))" strokeWidth={2} strokeDasharray="5 5" dot={{
                    fill: 'hsl(var(--muted-foreground))',
                    strokeWidth: 2,
                    r: 3
                  }} name="Invested" />
                  ...
                  </ResponsiveContainer> : <div className="flex flex-col items-center justify-center h-[400px] text-center space-y-4">
